  ...
  units:
    ...
    - name: |-
      ...
      content: |
        ...
        ExecStartPre=/bin/sh -c "docker run --rm --name %p -d --privileged -v /var/log/mesos:/var/log/mesos -e "LOGSTASH_URI=${logstash_uri}" -e "NODE_TYPE=mesos_master" ${filebeat_image}"
